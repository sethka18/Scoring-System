...
export const TIMETABLE_SUBJECTS_META: Record<string, { nameKm: string; nameEn: string; color: string; shortKm: string }> = {
  ...
  sub_moral_civics: { nameKm: 'សីលធម៌-ពលរដ្ឋ', nameEn: 'Moral & Civics', color: '#f59e0b', shortKm: 'សីលធម៌' },
  sub_geography_history: { nameKm: 'ភូមិ-ប្រវត្តិ', nameEn: 'Geography & History', color: '#d97706', shortKm: 'ភូមិ-ប្រវត្តិ' },
  sub_home_arts: { nameKm: 'គេហវិទ្យា-សិល្បៈ', nameEn: 'Home Economics & Arts', color: '#ec4899', shortKm: 'គេហ-សិល្បៈ' },
  sub_pe_sports: { nameKm: 'អប់រំកាយ-កីឡា', nameEn: 'Physical Education & Sports', color: '#06b6d4', shortKm: 'កីឡា' },
  sub_health_hygiene: { nameKm: 'សុខភាព-អនាម័យ', nameEn: 'Health & Hygiene', color: '#14b8a6', shortKm: 'សុខភាព' },
  sub_life_skills: { nameKm: 'អប់រំបំណិនជីវិត', nameEn: 'Life Skills Education', color: '#84cc16', shortKm: 'បំណិនជីវិត' },
  sub_foreign_lang: { nameKm: 'ភាសាបរទេស', nameEn: 'Foreign Language', color: '#6366f1', shortKm: 'ភាសាបរទេស' },
  sub_social: { nameKm: 'សិក្សាសង្គម', nameEn: 'Social Studies', color: '#ea580c', shortKm: 'សង្គម' },
