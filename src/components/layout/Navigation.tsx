  ...
  const categories: NavCategoryDef[] = [
    {
      ...
      items: [
        ...
        { 
          id: 'all_classes', 
          labelEn: 'All Classes Hub', 
          labelKm: 'គ្រប់គ្រងគ្រប់ថ្នាក់', 
          descKm: 'ពិនិត្យ និងកែប្រែថ្នាក់ទាំងអស់ក្នុងសាលា',
          descEn: 'Inspect & manage all classes in school',
          icon: Building2 
        },
        { 
          id: 'seating', 
